...
# output "private_connection_string01" {
#   description = "Copy/Paste/Enter - You are in the private ec2 instance"
#   value       = "ssh -i ${module.ssh-key.key_name}.pem ec2-user@${module.ec2.private_ip01}"
# }

# output "private_connection_string02" {
#   description = "Copy/Paste/Enter - You are in the private ec2 instance"
#   value       = "ssh -i ${module.ssh-key.key_name}.pem ec2-user@${module.ec2.private_ip02}"
# }
